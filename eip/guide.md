...
除此之外，还可以在 **全部产品** -\> **基础网络UNet** -\> **弹性IP** 页面，点击 **申请EIP**
按钮进行申请。

![image](/images/eip_2021051.png)

在申请流程中，可根据应用类型，选择与其相匹配的计费方式和带宽。

![image](/images/eip_2021052.png)


> 选择"指定IP地址"时，可选择最近一周内删除的，且未被占用的IP地址。
